...
| `OPENAI_API_KEY` | Cuando el provider es `api` | Ejecución de modelos OpenAI API |
| Inicio de sesión en Codex CLI | Cuando el provider es `codex` | Usa tu sesión local de Codex |
