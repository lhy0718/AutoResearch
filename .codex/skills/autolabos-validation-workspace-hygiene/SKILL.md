...
3. Promote required inputs to the workspace root.
4. Remove nested validation folders only after required inputs are copied.
5. Remove legacy root artifacts that could pollute the next run.
6. Re-list the workspace root and report the remaining files.
